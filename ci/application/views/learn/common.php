...
<link rel="stylesheet" type="text/css" href="/resource/h-ui/static/h-ui.admin/skin/default/skin.css" id="skin" />
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>超级管理员</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?php  if($username){echo $username;}else{ echo 'admin';} ?><i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
...
<script type="text/javascript" src="/resource/h-ui/static/h-ui/js/H-ui.js"></script> 
<script type="text/javascript" src="/resource/h-ui/static/h-ui.admin/js/H-ui.admin.page.js"></script> 
<!--/_footer /作为公共模版分离出去-->
...
<script type="text/javascript">
	$("#exit").click(function(){
		var params = '';
		load('index.php/entrance/logout',params)
	});
</script>
<!--/请在上方写此页面业务相关的脚本-->
